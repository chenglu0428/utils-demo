package com.chenglu.utils.demo.encryp;
...
public class ThreeDesUtils1 {
	 ...
	 * @throws Exception
	 */
	public static byte[] des3EncodeCBC(byte[] key, byte[] keviv, byte[] data) throws Exception {
		Key deskey = null;
		DESedeKeySpec spec = new DESedeKeySpec(key);
		SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("desede");
		deskey = keyFactory.generateSecret(spec);
		Cipher cipher = Cipher.getInstance("desede" + "/CBC/PKCS5Padding");
		IvParameterSpec ips = new IvParameterSpec(keviv);
